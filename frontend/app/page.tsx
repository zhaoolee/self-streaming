...
const STREAM_BASE = "http://192.168.106.170:8080/live";
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#090b10] text-white">
      ...
      <main className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl items-center px-6 py-10">
        <div className="grid w-full gap-8 lg:grid-cols-[1.2fr_0.8fr]">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/70 p-6 backdrop-blur-sm">
                  <div className="max-w-sm rounded-2xl border border-white/10 bg-black/60 p-6 text-center shadow-xl">
                    ...
                    <h2 className="mt-3 font-display text-2xl text-white">
                      Enter the password to unlock the stream
                    </h2>
                    <p className="mt-3 text-sm text-white/70">
                      The password is inserted into the HLS pull address.
                    </p>
                  </div>
                </div>
              ) : null}
          ...
          <aside className="flex h-full flex-col justify-between gap-6 rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_25px_70px_rgba(0,0,0,0.35)] backdrop-blur">
